 ...
 * @return AOI对象
 */
aoi_space *aoi_create(aoi_Alloc alloc,void *alloc_ud,float map_size[3],float tower_size[3],enterAOI_Callback cb_enterAOI,leaveAOI_Callback cb_leaveAOI, moveAOI_Callback cb_moveAOI, void *cb_ud);
/**
